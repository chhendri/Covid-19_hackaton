...
class ParticleSystem(object):
    def __init__(self, pop_size):
        ...
        self.hospital = Hospital(capacity=HOSPITAL_CAPACITY, radius=100)
    ...
    def run(self):
        while sum([part.is_contagious() for part in self.lst_particles]) > 0:
            ...
            for i in range(len(self.lst_particles)):
                ...
                # Hospital and stuff
                if part1.is_contagious() and part1.time_since_infected > INCUBATION_PERIOD:
                    if dist(*part1.pos) > self.hospital.radius:
                        ...
                        part1.hospital = True
                if not part1.is_contagious() and part1.job != "doc" and dist(*part1.pos) < self.hospital.radius \
                        and part1.time_since_infected >= INCUBATION_PERIOD:
...
class Particle(object):
    def __init__(self, infected=-1, age=-1, job=""):
        ...
        self.velocity = random.random()*2+1.5
        self.color = ""
        self.set_color()
